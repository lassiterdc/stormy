...
lst_template_keys = ["START_DATE", "START_TIME", "REPORT_START_DATE", "REPORT_START_TIME", "END_DATE", "END_TIME", "rainfall_1", "rainfall_2", "rainfall_4", "rainfall_5", "rainfall_7", "water_level", "OF_TYPE", "STAGE_DATA"]
