...
assar_dirs[hpc_d4c1_py]=${assar_dirs[hpc_scripts]}"d4c1_analyzing_weather_consolidation.sh"
assar_dirs[hpc_d4c2_py]=${assar_dirs[hpc_scripts]}"d4c2_analyzing_weather.sh"
